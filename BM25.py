...
class BM25:
    ...
    def get_top_n(self, query, documents, n=5):
        ...
        # print(top_n)
        return top_n, [documents[i] for i in top_n], [scores[i] for i in top_n]
...
class BM25Okapi(BM25):
    ...
    def get_scores(self, query):
        ...
        for q in query:
            ...
            upper = q_freq * (self.k1 + 1)
            below = (q_freq + self.k1 * (1 - self.b + self.b * doc_len / self.avgdl))
            score += (self.idf.get(q) or 0) * upper / below
